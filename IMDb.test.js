...
describe('IMDb class', () => {
  ...
  describe('getTruncatedtext()', () => {
    it('should properly truncate text', () => {
      const text = imdbInstance.getTruncatedText({text: 'Harry, Ron, and Hermione search for Voldemort and other things that will be truncated'})
  ...
  describe('getFormattedSearchResultWithPlot()', () => {
    it('should return expected object', () => {
      const objFormatted = imdbInstance.getFormattedSearchResultWithPlot({
        ...
        Year: '1991',
        Type: 'movie',
        'Plot': 'This is a very long plot and some if it will and should be truncated and I think if i type long enough it will be truncated',
        'imdbID': 'tt123456'
      })
